...
public class KerberosConfigurationImpl implements KerberosConfiguration {

    private final Properties kerberosProperties;

    public KerberosConfigurationImpl(Properties properties) {
        this.kerberosProperties = loadSubProperties(properties, "kerberos.");
    }
